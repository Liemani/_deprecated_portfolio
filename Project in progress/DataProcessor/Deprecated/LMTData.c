...
//
//	lmtData->data = (Data*)realloc(lmtData->data, ALLOC_INTERVAL * afterChunk);
...
//
//	lmtData->data[lmtData->count] = (Data)character;
//
//	++lmtData->count;
//}
//
//void LMTData__append__data(LMTData* lmtData, Data* data, int count) {
...
//}
//
//Data LMTDatag__removeLast(LMTData* lmtData) {
//	Data uCharacter = lmtData->data[lmtData->count - 1];
//
//	LMTData__reallocIfNeed(lmtData, -1);
//
//	--lmtData->count;
...
//
//	free(lmtData->data);
//	lmtData->data = (Data*)malloc(ALLOC_INTERVAL * lmtData->chunk);
//}
//
//
//
...
//}
//
//static LMTData* newLMTData__designated(Data* data, int count, int chunk) {
//	LMTData* lmtData = allocLMTData();
//
//	lmtData->count = count;
//	lmtData->chunk = chunk;
//
//	lmtData->data = (Data*)malloc(ALLOC_INTERVAL * chunk);
//
//	if (data)
...
//}
//
//LMTData* newLMTData__data(Data* data, int count) {
...
//	if (string) return newLMTData__data((Data *)string, strlen(string));
//
//	return newLMTData();
//}
//
