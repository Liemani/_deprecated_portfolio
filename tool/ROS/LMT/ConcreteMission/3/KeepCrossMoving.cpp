...
// callback function
void KeepCrossMoving::callWhenPositionChanged(Mission* pMission, Drone& drone) {
    // code goes here...
}

void KeepCrossMoving::callWhenAltitudeChanged(Mission* pMission, Drone& drone) {
    // code goes here...
}

void KeepCrossMoving::callWhenBearingChanged(Mission* pMission, Drone& drone) {
    // code goes here...
}
...
// public
KeepCrossMoving::KeepCrossMoving()
: ConcreteMission() {
...
//  false: on going
bool KeepCrossMoving::perform(vector<Drone*>& pDrone_vector) {
...
void KeepCrossMoving::debugDescription() {
    // code goes here..

}

void KeepCrossMoving::setTargetAltitude(double targetAltitude)
{
